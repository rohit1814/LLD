...
# Solution:
## To fix this we will create a default constructor inside Logger and NotificationEngine class 
## and ask NotifitionService to give observable object and add observers to observable
...
class Logger(IObserver):
    # default constructor to get observable from NotificationService and add the observers
    # def __init__(self) -> None:
    #     service = NotificationService()
    #     self._observable = service.get_observable()
    #     self._observable.add_observer(self)
    
    # def __init__(self, observable: NotificationObservable) -> None:
    #     self._observable = observable

    # Instead of using two constructor use one constructor with optional parameter --> Reason python always executes last constructor (i.e Constructor Overloading is not possible in python)
    def __init__(self, observable: NotificationObservable | None = None) -> None:
        service = NotificationService()
        self._observable = observable or service.get_observable()
        self._observable.add_observer(self)
